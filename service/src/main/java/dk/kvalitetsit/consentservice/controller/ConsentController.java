...
public class ConsentController extends AbstractController {
	...
	public ConsentDTOs getAllConsents(@RequestHeader(sessionDataKey) String sessionData) throws IOException {
	...
	public ConsentTemplateDTO getConsentTemplate(@RequestParam("consentTemplateId") long consentTemplateId) {
